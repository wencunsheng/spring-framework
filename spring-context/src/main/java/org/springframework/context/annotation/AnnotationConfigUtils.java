...
public abstract class AnnotationConfigUtils {
	...
	/**
	 * applyScopedProxyMode 方法根据注解 Bean 定义类中配置的作用域 @Scope 注解的值，为 Bean 定义应用相应的代理模式，主要是在 Spring 面向切面编程(AOP)中使用。
	 * @param metadata
	 * @param definition
	 * @param registry
	 * @return
	...
	static BeanDefinitionHolder applyScopedProxyMode(
		...
		//获取配置的@Scope 注解的 proxyMode 属性值，如果为 TARGET_CLASS则返回 true，如果为 INTERFACES，则返回 false
